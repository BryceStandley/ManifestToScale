/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 374df68d2333e81357741602cf688801)
// Runtime types generated with workerd@1.20250523.0 2025-05-23 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		FROM_EMAIL: "noreply@ftg.vectorpixel.net";
		API_ENDPOINT: "https://cf.ftgapi.vectorpixel.net/api/files" | "http://127.0.0.1:8787/api/files";
