/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2defb5aaec522a0b0a67c41fe078eb5f)
// Runtime types generated with workerd@1.20250617.0 2025-05-29 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		MANIFEST_VENDOR: "unknown";
		ALLOWED_SENDERS: string;
		ACKNOWLEDGEMENT_EMAILS: string;
		API_ENDPOINT: string;
		DEV_API_ENDPOINT: string;
		API_TOKEN: string;
		FROM_EMAIL: string;
		IS_LOCAL: string;
		SKIP_DB_CHECK: string;
		SKIP_EMAIL_SEND: string;
		MAILGUN_API_KEY: string;
		MAILGUN_API_KEY1: string;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MANIFEST_VENDOR" | "ALLOWED_SENDERS" | "ACKNOWLEDGEMENT_EMAILS" | "API_ENDPOINT" | "DEV_API_ENDPOINT" | "API_TOKEN" | "FROM_EMAIL" | "IS_LOCAL" | "SKIP_DB_CHECK" | "SKIP_EMAIL_SEND" | "MAILGUN_API_KEY" | "MAILGUN_API_KEY1">> {}
}
