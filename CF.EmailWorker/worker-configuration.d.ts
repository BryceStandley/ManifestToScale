/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 813a76e98ea7e7e2699bd7e56ce67d3b)
// Runtime types generated with workerd@1.20250523.0 2025-05-23 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		FROM_EMAIL: "noreply@ftg.vectorpixel.net";
		API_ENDPOINT: "https://m2s.ftgapi.vectorpixel.net/api/files" | "http://127.0.0.1:8787/api/files";
		...
		IS_LOCAL: "false" | "true";
		SKIP_DB_CHECK: "false" | "true";
		SKIP_EMAIL_SEND: "false" | "true";
		MANIFEST_VENDOR: "unknown";
		DEV_API_ENDPOINT: "http://127.0.0.1:8787/api/files";
		MAILGUN_API_KEY: string;
		FORCE_SEND_ACK: string;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FROM_EMAIL" | "API_ENDPOINT" | "ALLOWED_SENDERS" | "ACKNOWLEDGEMENT_EMAILS" | "IS_LOCAL" | "SKIP_DB_CHECK" | "SKIP_EMAIL_SEND" | "MANIFEST_VENDOR" | "DEV_API_ENDPOINT" | "MAILGUN_API_KEY" | "FORCE_SEND_ACK">> {}
}
